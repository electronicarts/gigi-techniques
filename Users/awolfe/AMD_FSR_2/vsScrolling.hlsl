...
{
    float3 a = float3(0.0f, 1.0f, 4.0f - float(input.instanceId) * 9.0f);
    float3 b = float3(0.0f, 2.0f, 4.0f - float(input.instanceId) * 9.0f);
    float3 c = float3(0.0f, 2.0f, 5.0f - float(input.instanceId) * 9.0f);
    float3 d = float3(0.0f, 1.0f, 5.0f - float(input.instanceId) * 9.0f);
