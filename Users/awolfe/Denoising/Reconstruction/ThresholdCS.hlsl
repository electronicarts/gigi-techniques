...
/*$(_compute:ThresholdCS)*/(uint3 DTid : SV_DispatchThreadID)
{
	...
	switch(/*$(Variable:NoiseType)*/)
	{
		...
		case ENoiseType::Blue: randomValue = SampleSpatioTemporalTexture(/*$(Image2DArray:NoiseTextures/real_uniform_gauss1_0_exp0101_separate05_%i.png:R8_Unorm:float:false)*/, DTid.xy, frameIndex); break;
		case ENoiseType::Binomial: randomValue = SampleSpatioTemporalTexture(/*$(Image2DArray:NoiseTextures/real_uniform_binomial3x3_exp0101_separate05_%i.png:R8_Unorm:float:false)*/, DTid.xy, frameIndex); break;
	}
