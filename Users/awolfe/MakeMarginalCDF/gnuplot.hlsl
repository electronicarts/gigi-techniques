// adapted from https://github.com/kbinani/colormap-shaders/blob/master/shaders/glsl/gnuplot.frag
...
float4 colormap(float x, int red_type, int green_type, int blue_type) {
    return float4(colormap_f1(red_type, x), colormap_f1(green_type, x), colormap_f1(blue_type, x), 1.0);
}