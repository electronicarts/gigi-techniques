...
# To use the model from https://www.youtube.com/watch?v=jDe5BAsT2-Y
# 96.52% for 8KB
...
if __name__ == "__main__": 
    ...
    if (not os.path.exists("train2.pt")):
        ...
        with open('train2.pt', 'wb') as f: 
            save(clf.state_dict(), f) 

    with open('train2.pt', 'rb') as f: 
    ...
    for key, value in od.items():
        ...
        theValue.tofile("train2." + key + ".bin",)

    #print(od["model.0.weight"])
    #print(od["model.0.bias"])
