...
# To use the model from https://github.com/pytorch/examples/blob/main/mnist/main.py
# 98.92% for 4,691KB
...
opt = Adam(clf.parameters(), lr=1e-3) # They used Adadelta, but i got worse results with that.
loss_fn = nn.NLLLoss() 
...
if __name__ == "__main__": 
    ...
    if (not os.path.exists("train3.pt")):
        ...
        with open('train3.pt', 'wb') as f: 
            save(clf.state_dict(), f) 

    with open('train3.pt', 'rb') as f: 
    ...
    #     theValue.tofile("train3." + key + ".bin",)
